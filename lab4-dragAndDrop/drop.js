...
function create ()
{
    var background = this.add.sprite(1000, 1000, 'background');
    ...
    var mouth2 = this.add.sprite(1000, 400, 'mouth2');
    var mouth1 = this.add.sprite(1000, 450, 'mouth1');
    var nose = this.add.sprite(1000, 500, 'nose');
